...
- Add custom currency system with profiles, rules, and denomination support by @thomsa
...
- Add bid extension (anti-sniping) feature with multi-language support by @thomsa
...
- Add SkeletonBulkEditTable component for loading states in Auction Admin by @thomsa
...
- Rename troubleshooting section to FAQ & Troubleshooting and add realtime features navigation by @thomsa
...
- Add UserAvatar component and improve bid error logging by @thomsa

## [1.16.3] - 2026-01-08

### 🚀 Features

- Add type-safe channel names with branded types for realtime system by @thomsa

## [1.16.2] - 2026-01-08

### 🚀 Features

- Add Vercel Live to CSP and improve realtime/theme hydration by @thomsa

## [1.16.1] - 2026-01-07

### 🚀 Features

- Add Pusher WebSocket domain to CSP connect-src directive by @thomsa

## [1.16.0] - 2026-01-07

### 🚀 Features

- Add realtime WebSocket support with Soketi and Pusher integration  by @thomsa in [#40](https://github.com/thomsa/auktiva/pull/40)
...
- Introduce redirect after login to original urls by @thomsa
- Add polling interval hook with tab visibility and priority-based intervals by @thomsa
...
- Add bulk edit and CSV import UI buttons with translations by @thomsa
- Add draft/publish system for auction items with translations by @thomsa
