...
INSERT INTO "new_auctions" ("bidderVisibility", "createdAt", "creatorId", "description", "endDate", "id", "inviteToken", "itemEndMode", "joinMode", "memberCanInvite", "name", "thumbnailUrl", "updatedAt") SELECT "bidderVisibility", "createdAt", "creatorId", "description", "endDate", "id", "inviteToken", "itemEndMode", "joinMode", "memberCanInvite", "name", "thumbnailUrl", "updatedAt" FROM "auctions";
DROP TABLE "auctions";
